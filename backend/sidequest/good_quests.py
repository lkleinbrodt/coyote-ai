GOOD_QUESTS = [
    ...
    "Puzzle: Estimate how many steps it would take to walk from your home to the nearest grocery store.",
    "Puzzle: Estimate the number of streetlights in your city.",
    "Puzzle: Estimate how many emails you’ve sent in the past year.",
    "Puzzle: Estimate the number of words in your favorite book.",
    "Puzzle: Estimate how many cups of coffee/tea are consumed daily in your country.",
    "Puzzle: Estimate how many people are currently in the nearest stadium/arena (if an event were happening).",
    "Puzzle: Estimate the number of windows in your home/apartment building.",
    "Puzzle: Estimate how many cars pass by your street in an hour.",
    "Puzzle: Estimate the total number of steps you take on an average day.",
    "Puzzle: Estimate how many gallons of water you use in a 10-minute shower.",
    ...
    "Puzzle Estimate how many piano tuners there are in your city",
    "Puzzle Estimate how many people are awake in your city right now.",
    "Puzzle Estimate how many pizzas are being delivered in your country in the next hour.",
    "Puzzle Estimate how many steps it would take to walk the length of your street.",
    "Puzzle Estimate how many lightbulbs are turned on in your apartment building at this exact moment.",
    "Puzzle Estimate how many gallons of paint it would take to cover your entire living space.",
    "Puzzle Estimate how many dogs live within a 1-mile radius of your home.",
    "Puzzle Estimate how many airplanes are over your country right now.",
    "Puzzle Estimate how many gallons of water flow through your shower in 1 minute.",
    "Puzzle Estimate how many words you’ve spoken in your life so far.",
    "Puzzle Estimate how many chairs exist in your city.",
    "Puzzle Estimate how many photographs are taken worldwide in a single day.",
    "Puzzle Estimate how many cups of coffee are consumed on Earth every second.",
    "Puzzle Estimate how many times your heart has beaten in your lifetime.",
    "Puzzle Estimate how many songs are being played on Spotify right now.",
    "Puzzle Estimate how many tennis balls would fit inside your living room.",
    "Puzzle Estimate how many cars are currently parked vs. moving in your city.",
    "Puzzle Estimate how many books are in all the libraries of your country combined.",
    "Puzzle Estimate how many minutes of commercials you’ve watched in your lifetime.",
    "Puzzle Estimate how many people share your exact birthday worldwide.",
