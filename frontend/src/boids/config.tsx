...
const BOID_CONFIG: BoidConfig = {
  ...
  centeringFactor: 0.1, // Cohesion - strength of attraction to flock center
  matchingFactor: 0.1, // Alignment - strength of velocity matching
  ...
  // Flock configuration
  numBoids: 1000, // Total number of boids
...
const CAMERA_CONFIG: CameraConfig = {
  moveSpeed: 0.5,
  rotateSpeed: 0.02,
  initialPosition: new THREE.Vector3(28, 20, 28),
};
